    ...
    <>
        ...
        <Link to='/'>
          ...
          <div className="flex items-center gap-3">
            {!session?.user ? (
              ...
              <>
              <button className='bg-white/10 px-5 text-xs sm:text-sm border text-gray-200 rounded-full'>Credits: <span className='text-indigo-300'>{credits}</span></button>
        ...
        {menuOpen && (
          <div className="fixed inset-0 z-100 bg-black/60 text-white backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300">
            ...
            <Link to='/pricing' onClick={() => setMenuOpen(false)}>Projects</Link>
